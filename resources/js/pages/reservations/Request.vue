...
const hasIntent = computed(() => Boolean(props.intent) && !isAuthenticated.value);
            ...
            >
                <section class="space-y-6 lg:w-6/12">
                    ...
                    <div class="space-y-4">
                        ...
                        <h1
                            class="font-[var(--welcome-font-serif)] text-4xl leading-tight text-[color:var(--welcome-ink-strong)] sm:text-5xl"
                        >
                        ...
                        <p class="max-w-xl text-lg text-[color:var(--welcome-ink-muted)]">
                            ...
                            <span class="font-semibold text-[color:var(--welcome-ink-strong)]">
                    ...
                    >
                        {{ $t('reservations.public.hero.notice', { from: props.openingHours.from, to: props.openingHours.to }) }}
                    </div>
                </section>
                        ...
                        <div class="space-y-6">
                            <div>
                                <p class="welcome-kicker">
                                    {{ hasIntent ? $t('reservations.public.auth.kicker') : $t('reservations.public.form.kicker') }}
                                </p>
                                <h2 class="welcome-title">
                                    {{ hasIntent ? $t('reservations.public.auth.title') : $t('reservations.public.form.title') }}
                                </h2>
                                <p class="mt-2 text-sm text-[color:var(--welcome-ink-muted)]">
                                    {{ hasIntent ? $t('reservations.public.auth.description') : $t('reservations.public.form.description') }}
                                </p>
                            </div>
                            ...
                            <ReservationForm
                                ...
                                :submit-label="$t('reservations.public.form.submit')"
                                @intent="createIntent"
                            />
